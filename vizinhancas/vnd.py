...
from vizinhancas.reinsertion_inter import reinsercao_interrotas
from vizinhancas.reinsertion_intra import reinsertion_intrarrotas
from vizinhancas.swap_11_intra import swap_1_1_intrarrotas

def VND(pistas, custo_atual, dados):
    k_max = 4 # número de vizinhancas
    k_atual = 0
    while k_atual < k_max:
        if k_atual == 0:
            ...
            solucao_nova, custo_novo = reinsercao_interrotas(pistas, dados)
